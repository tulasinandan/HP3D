...
!!!!!!! Turbulent initial conditions generated by Bill's code
  Real(kind=drk), Dimension(0:nx+1,0:ny+1,0:nz+1) :: fbx, fby, fvx, fvy, np
...
! set electric and magnetic field (no kinetic equilibrium with guide field bz)
  do z=1,nz; do y=1,ny; do x=1,nx
    b1x(x,y,z)=fbx(x,y,1); b1y(x,y,z)=fby(x,y,1); b1z(x,y,z)=b0
  enddo; enddo; enddo
...
!    write(9,*),''
!    write(9,*),'x,y,rvix,rviy,fvx,fvy,vix,viy',xx,yy,rvi(4,i),rvi(5,i),fvx(xx,yy,1),fvy(xx,yy,1),vix,viy
!    write(9,*),''
